...
if(isset($_POST['name']) && isset($_POST['mobile']) && isset($_POST['email']) && isset($_FILES['photo']))
{
  if(!empty($_POST['name']) && !empty($_POST['mobile']) && !empty($_POST['email']) && !empty($_FILES['photo']))
  {
    $candi = new Candidate;
    $candi->setCandidateName($_POST['name']);
    $candi->setCandidateMobile($_POST['mobile']);
    $candi->setCandidateEmail($_POST['email']);
    $candi->setElectionId($_POST['getElection_ID']);

    $location = "../uploads/".date("h-i-s").$_FILES["photo"]["name"];
    if(move_uploaded_file($_FILES["photo"]["tmp_name"], $location))
    {
        $candi->setCandidatePhoto($location);
        if($candi->AddCandidate($candi))
        {
...
<body >
  ...
  <!-- _________________________________________Whole Page___________________________________________________________ -->
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row" style="border-bottom: 4px solid #2c4755 !important;">
            ...
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                ...
                <li class="nav-item nav-profile dropdown">
                    ...
                    <span class="nav-profile-name">Kojito</span>
                    </span>
                </li>
                </ul>
                        ...
                        <div class="row" style="justify-content: center;">
                            <div class="col-md-10">
                                <div class="contact-form-home bg-white" style="border-radius: 20px;">
                                    <h1 class="text-center pt-3 pb-4">Add New Candidate</h1>
                                    <?php
                                        if($errMsg != "")
                                        {
                                            ?>
                                    ...
                                    <?php
                                        ...
                                        {
                                            ?>
                                                <div class="alert alert-danger" role="alert"> Can't Add Candidate, There is no Election</div>
                                            <?php
                                        }
                                        else
                                        {
                                            ?>
                                                <form class="row g-3 needs-validation" action="admin-candidates.php" method="POST" novalidate enctype="multipart/form-data">
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="mobile" id="validationCustom01" required>
                                                        <div class="valid-feedback">
                                                        Looks good!
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <label for="validationCustom03" class="form-label">Elections</label>
                                                        <select class="form-control" name="getElection_ID" id="">
                                                            <?php
                                                    ...
                                                    <div class="col-12">
                                                        <button class="vote_btn  me-3 mt-3 mb-3 col-md-12" type="submit">ADD</button>
                                                    </div>
                                                </form>
                                            <?php
                                        }
    ...
    <!-- Candidates Table -->
    <div style="padding-left: 5px; padding-right: 5px; width: 100%; margin-bottom: 20px; text-align: center;">
        <h3 style="margin: 40px; font-weight: bold; color: #2c4755;">Candidates</h3>
        <div class="row">
                    <div class="col-md-12">
                        <?php
                            ...
                            {
                                ?>
                                    <div class="alert alert-danger" role="alert">No Candidates for Now</div>
                                <?php
                            }
                            else
                            {
                                ...
                                foreach($candidates as $candidate)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="<?php echo $candidate["photo"] ?>" alt=""></td>
                                        <td>
                                            <?php 
                                                if($candidate["nominated"] == 0)
                                                {
                                                    ?>
