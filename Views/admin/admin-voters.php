  ...
  <!-- _________________________________________Whole Page___________________________________________________________ -->
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper" style="  background-color: white !important; justify-content: space-around;">
            ...
            <!-- ======================= 3- Start Main Panel ======================= -->
            <div style="padding-left: 5px; padding-right: 5px; width: 80%;">
                <h3 style="margin: 40px;">Voters</h3>
                <div class="row">
                    <div class="col-md-12">
                        <?php
                            if(count($voters)==0)
                            {
                                ?>
                                    <div class="alert alert-danger" role="alert">No Voters for Now</div>
                                <?php
                            }
                            else
                            {
    ...
    <!-- Footer -->
    <footer class="text-center text-lg-start" style="background-color: #2c4755; margin-top: 20px; position: absolute; bottom: 0; width: 100%;">
        <!-- Copyright -->
